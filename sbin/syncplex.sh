...
find /mnt/cloteal/Plex -type d -print -exec chmod 775 {} \; >> /dev/null 2>&1
find /mnt/cloteal/Plex -type f -print -exec chmod 664 {} \; >> /dev/null 2>&1
...
PLEX1=/mnt/cloteal/Plex
PLEXX=/mnt/cloteal/Plexx
...
# Run a system update
$PROGRAM_DIRECTORY/upd.sh > /dev/null 2> /dev/null &
