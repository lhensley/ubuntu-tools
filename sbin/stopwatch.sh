...
if [ -z "$1" ]; then
	echo "Usage: "
	echo "stopwatch.sh name start (e.g., stopwatch \"Test Stopwatch\" start):" 
	echo "          Starts the counter from zero."
	echo "stopwatch.sh name lap (e.g., stopwatch \"Test Stopwatch\" lap):"
	echo "          Marks a lap and displays all laps. Can be used multiple times."
	echo "stopwatch.sh name # (e.g., stopwatch \"Test Stopwatch\" 60 ):"
